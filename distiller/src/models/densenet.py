...
from .model import  L2Norm, Flatten
from .common_utility import get_dense_ave_pooling_size
...
class DenseNet(nn.Module):
    ...
    """
    def __init__(self, input_size = (112,112), growth_rate=32, block_config=(6, 12, 24, 16),
        ...
        pool_kernel = get_dense_ave_pooling_size(input_size[0], input_size[1],block_config)
        self.avepool = nn.AvgPool2d(kernel_size=pool_kernel, stride=1)
