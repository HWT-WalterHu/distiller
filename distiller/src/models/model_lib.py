...
class FaceNet_60(Module):
    def __init__(self, embedding_size = 512, height = 112, width = 96):
        super(FaceNet_60, self).__init__()
        self.conv1 = Conv_block(3, 64, kernel=(3,3), stride=(2,2), padding=(1,1), groups=1)
        self.conv1_res = Common_Residual(FaceNet_Res_Elem_conv_relu, 64,64,3, kernel=(3,3), stride=(1,1), padding=(1,1), groups=1)
        self.conv2 = Conv_block(64, 128, kernel=(3, 3), stride=(2, 2), padding=(1, 1), groups=1)
        self.conv2_res = Common_Residual(FaceNet_Res_Elem_conv_relu, 128,128, 8, kernel=(3,3), stride=(1,1), padding=(1,1), groups=1)
        self.conv3 = Conv_block(128, 256, kernel=(3, 3), stride=(2, 2), padding=(1, 1), groups=1)
        self.conv3_res = Common_Residual(FaceNet_Res_Elem_conv_relu, 256,256, 14, kernel=(3,3), stride=(1,1), padding=(1,1), groups=1)
        self.conv4 = Conv_block(256, 512, kernel=(3, 3), stride=(2, 2), padding=(1, 1), groups=1)
        self.conv4_res = Common_Residual(FaceNet_Res_Elem_conv_relu, 512,512, 3, kernel=(3,3), stride=(1,1), padding=(1,1), groups=1)
        self.flatten = Flatten()
        self.linear = Linear(
            512* Get_Conv_Size(height, width, kernel=(3,3), stride=(2,2), padding=(1,1), rpt_num=4),
            embedding_size)
...
class FaceNet_36(Module):
    def __init__(self, embedding_size = 512, height = 112, width = 96):
        super(FaceNet_36, self).__init__()
        self.conv1 = Conv_block(3, 64, kernel=(3,3), stride=(2,2), padding=(1,1), groups=1)
        self.conv1_res = Common_Residual(FaceNet_Res_Elem_conv_relu, 64,64,2, kernel=(3,3), stride=(1,1), padding=(1,1), groups=1)
        self.conv2 = Conv_block(64, 128, kernel=(3, 3), stride=(2, 2), padding=(1, 1), groups=1)
        self.conv2_res = Common_Residual(FaceNet_Res_Elem_conv_relu, 128,128, 4, kernel=(3,3), stride=(1,1), padding=(1,1), groups=1)
        self.conv3 = Conv_block(128, 256, kernel=(3, 3), stride=(2, 2), padding=(1, 1), groups=1)
        self.conv3_res = Common_Residual(FaceNet_Res_Elem_conv_relu, 256,256, 8, kernel=(3,3), stride=(1,1), padding=(1,1), groups=1)
        self.conv4 = Conv_block(256, 512, kernel=(3, 3), stride=(2, 2), padding=(1, 1), groups=1)
        self.conv4_res = Common_Residual(FaceNet_Res_Elem_conv_relu, 512,512, 2, kernel=(3,3), stride=(1,1), padding=(1,1), groups=1)
        self.flatten = Flatten()
        self.linear = Linear(
            512* Get_Conv_Size(height, width, kernel=(3,3), stride=(2,2), padding=(1,1), rpt_num=4),
            embedding_size)
...
class FaceNet_104(Module):
    def __init__(self, embedding_size = 512, height = 112, width = 96):
        super(FaceNet_104, self).__init__()
        self.conv1 = Conv_block(3, 64, kernel=(3,3), stride=(2,2), padding=(1,1), groups=1)
        self.conv1_res = Common_Residual(FaceNet_Res_Elem_conv_relu, 64,64,3, kernel=(3,3), stride=(1,1), padding=(1,1), groups=1)
        self.conv2 = Conv_block(64, 128, kernel=(3, 3), stride=(2, 2), padding=(1, 1), groups=1)
        self.conv2_res = Common_Residual(FaceNet_Res_Elem_conv_relu, 128,128, 8, kernel=(3,3), stride=(1,1), padding=(1,1), groups=1)
        self.conv3 = Conv_block(128, 256, kernel=(3, 3), stride=(2, 2), padding=(1, 1), groups=1)
        self.conv3_res = Common_Residual(FaceNet_Res_Elem_conv_relu, 256,256, 36, kernel=(3,3), stride=(1,1), padding=(1,1), groups=1)
        self.conv4 = Conv_block(256, 512, kernel=(3, 3), stride=(2, 2), padding=(1, 1), groups=1)
        self.conv4_res = Common_Residual(FaceNet_Res_Elem_conv_relu, 512,512, 3, kernel=(3,3), stride=(1,1), padding=(1,1), groups=1)
        self.flatten = Flatten()
        self.linear = Linear(
