...
class MnasNet(nn.Module):
    def __init__(self, embedding_size = 128, width_mult=1.):
        ...
        self.flat = Flatten()
        self.linear = nn.Linear(320, embedding_size, bias=False)
        self.l2 = L2Norm()
...
if __name__ == '__main__':
    ...
    writer = SummaryWriter("/home/zkx-97/PycharmProjects/MnasNet-PyTorch/MNasNet_Structure")
