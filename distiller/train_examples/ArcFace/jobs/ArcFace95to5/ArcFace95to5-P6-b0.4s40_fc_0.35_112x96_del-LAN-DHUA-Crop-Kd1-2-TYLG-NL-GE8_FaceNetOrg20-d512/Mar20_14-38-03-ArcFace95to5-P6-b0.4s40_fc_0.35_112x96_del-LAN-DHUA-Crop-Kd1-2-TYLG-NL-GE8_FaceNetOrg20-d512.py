...
# training param
def train(device_ids, resume_training):
...
#    conf.test_set = ["Business_small_95to5", "XCH_out2_95to5"]
    ...
    learner = TrainFace(conf)
    learner.train_model()

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='for face verification')
    parser.add_argument("-device", "--device_ids", help="which gpu id, 0123",default="0", type=str)
    parser.add_argument("-resume", "--resume_training", help="resume training 0-not or 1-resume", default=0, type=int)
    ...
    train(devices, args.resume_training)
